            ...
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" className="w-12 h-12">
                  ...
                  <path fill="#17A299" d="M200.36,466.12c9.64-2.8,28.97,16.56,22.15,25.31c1.07,1.63,1.4,6.91,3.54,10.56c8.6,14.69,25.45,18.07-6.7,24.24c-20.86-19.73-29.69-25.35-47.46-50.62C182.63,454.05,192.74,481.36,200.36,466.12z"/>
                  <path fill="#169586" d="M912.23,368.04c0.45,12.83-3.66,22.8-6.33,34.8c-9.06,6.86-12.06-7.01-15.65-10.56c-4.95-4.9-12.99,2.34-9.66-14.75l-5.12-6.49l7.84-45.94l6.77-4.52l20.43,35.06C912.9,359.58,912.08,363.79,912.23,368.04z"/>
                  ...
                  <path fill="#FCFDFD" d="M655.96,282.62c27.13-29.81,91.37-70.86,113.9-15.82c-8.97,20.39-1.73,38.67-3.94,57.7c-1.17,10.09-19.51,74.59-26.09,75.09c-11.18-7.97-17.99-15.71-33.25-12.57c-17.53-16.59-35.97-34.59-53.79-50.62c-26.39-0.91-34.21-14.38-14.99-34.82L655.96,282.62z"/>
                  <path fill="#F4FBF8" d="M655.96,282.62c-10.61,11.66-34.04,32.44-16.09,48.51c3.67,3.29,8.37,1.18,12.92,5.28c-24.89-4.93-32.92,17-48.96,31.72c-54.93,50.45-107.81,103.02-161.45,154.82c-3.61-6.21-21.55-13.05-20.34-20.02L655.96,282.62z"/>
                </svg>
              </div>
              <div>
