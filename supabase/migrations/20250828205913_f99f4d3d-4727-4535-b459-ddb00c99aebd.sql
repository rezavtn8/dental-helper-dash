...
-- Keep the existing policies for owners and creation during setup
-- The "Anyone can create clinics during setup" and "Clinic owners can manage their clinic" policies remain unchanged
