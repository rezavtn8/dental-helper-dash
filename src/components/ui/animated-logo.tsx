  ...
  return (
    <div className={cn("relative", sizes[size], className)}>
      ...
      >
          ...
          <style>
            {`
              ...
              .logo-path-2 {
                ...
                animation: draw 4s ease-in-out infinite 0.5s;
              }
              .logo-path-3 {
                stroke-dasharray: 800;
                stroke-dashoffset: 800;
                animation: draw 4s ease-in-out infinite 1s;
              }
              .logo-path-4 {
                stroke-dasharray: 600;
                stroke-dashoffset: 600;
                animation: draw 4s ease-in-out infinite 1.5s;
              }
              @keyframes draw {
                0% {
                  stroke-dashoffset: 2000;
        ...
        {/* Main logo paths with stroke animations */}
        <path 
