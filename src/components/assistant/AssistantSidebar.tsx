              ...
              <>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Assistant Portal</p>
                  </div>
                </div>
                <Button
                  variant="ghost"
        ...
        <div className="p-6 border-b border-gray-100">
          <DropdownMenu>
            ...
            <DropdownMenuContent align={isCollapsed ? "start" : "end"} className="w-56">
              <DropdownMenuItem onClick={() => onTabChange('pin')}>
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <Button
                ...
                className={`
                  w-full justify-start text-left h-14 font-medium transition-all duration-200 text-base
