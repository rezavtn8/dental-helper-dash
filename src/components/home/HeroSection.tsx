      ...
      <div className="container mx-auto text-center relative z-10 max-w-6xl">
        ...
        >
          ...
          <div className="text-center -mt-1 sm:-mt-2">
            <h2 className="text-3xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-foreground">DentaLeague</h2>
          </div>
        </div>

        {/* Headline */}
        <h1 
          className={`text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-semibold mb-3 sm:mb-5 leading-tight sm:leading-normal bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent px-2 transition-all duration-1000 ease-out ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        ...
        {/* Subtext */}
        <p 
          className={`text-sm sm:text-sm lg:text-base text-muted-foreground mb-4 sm:mb-6 max-w-lg lg:max-w-2xl mx-auto leading-relaxed px-2 transition-all duration-1000 ease-out ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
