...
import { useAuthSignInForm, useFormErrors } from '@/hooks/useFormValidation';
...
export default function SignInForm() {
  ...
  const handleEmailSignIn = async (data: any) => {
    ...
    try {
      ...
      const { error } = await signInWithEmail(sanitizedEmail, data.password);
  ...
  return (
    <div className="space-y-6">
      <form onSubmit={signInForm.handleSubmit(handleEmailSignIn)} className="space-y-6">
