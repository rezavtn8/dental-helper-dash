  ...
  const getPathStyle = (): React.CSSProperties => {
    ...
    if (!animated) {
      return {
        ...
        strokeDashoffset: 0,
        fillOpacity: 1,
        strokeOpacity: 0, // No stroke for solid version
        strokeWidth: 0,
        stroke: 'none',
        strokeLinecap: 'round',
    ...
    return {
      ...
      stroke: 'hsl(220 91% 20%)', // Dark blue for visibility on light background
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
    ...
    <>
      ...
      >
        ...
        >
            <path 
            ref={pathRef}
            fill={animated ? "hsl(220 91% 20%)" : "currentColor"} 
            stroke={animated ? "hsl(220 91% 20%)" : "none"}
            strokeWidth="3"
            style={getPathStyle()}
